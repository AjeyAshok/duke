...
If you have imported your Gradle project into IntelliJ IDEA, you will notice that IDEA is able to Task the test directory as the _Test root_ (colored in green by default) automatically.
